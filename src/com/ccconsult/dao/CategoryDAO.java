...
import com.ccconsult.pojo.Category;
...
/**
	 ...
	 * @see com.ccconsult.pojo.Category
...
public class CategoryDAO extends BaseHibernateDAO {
    ...
    public Category findById(java.lang.Integer id) {
        ...
        try {
            Category instance = (Category) getSession().get("com.ccconsult.pojo.Category", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(Category instance) {
        ...
        try {
            List results = getSession().createCriteria("com.ccconsult.pojo.Category")
